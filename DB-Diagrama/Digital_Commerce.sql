...
(1, 'Teclado mecánico Redragon K630', 60000, 'Nuevo', 'teclado_red.png', 'Disfrutá de tus partidas en otro nivel con Redragon, marca reconocida que se especializa en brindar la mejor experiencia de juego al público gamer desde hace más de 20 años. Sus teclados se adaptan a todo tipo de jugadores y esto los convierten en un fiel reflejo de la alta gama y calidad que la compañía ofrece.'),
...
(4, 'Monitor Gamer Gigabyte Curvo 165hz 1ms', 600000, 'Usado', 'monitor.png', 'Disfrutá de todas las cualidades que el monitor Gigabyte G27FC tiene para ofrecerte. Percibí las imágenes de una manera completamente diferente y complementá cualquier espacio ya sea en tu casa u oficina.'),
...
(8, 'Mouse Pad Gamer Oficina Xl Negro Antideslizante 80x40 Cm 3mm', 7200, 'Nuevo', 'mousepad.png', 'Es tan fácil deslizar el mouse. Con tu Alitrade MP408003-1 podrás llenar la pantalla de tu ordenador de clicks. Su elaborada superficie le dará precisión y comodidad a tus movimientos.'),
(9, 'Procesador Amd Ryzen 97900X AMD', 800000, 'Usado', 'Procesador-Amd-Ryzen-9-7900X.png', 'El AMD Ryzen™ 9 7900X es un potente procesador para computadoras de escritorio para gaming y streaming que está diseñado con 12 núcleos de CPU y 24 subprocesos, y tiene una velocidad de reloj base de 4,7 GHz.'),
(10, 'Memoria Kingston FURY DDR5', 80000, 'Nuevo', 'MEMORIADDR5.png', 'DDR5 duplica el número de bancos de 16 a 32. Esto permite abrir más páginas simultáneamente, con el consiguiente aumento de la eficiencia. También se duplica la longitud mínima de ráfaga hasta 16, desde los 8 de DDR4.'),
